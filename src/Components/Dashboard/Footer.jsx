  ...
  return (
    <footer className="relative w-full bg-gray-800">
      <div className=" relative mx-auto w-full max-w-7xl px-8">
        <div className="grid grid-cols-1 justify-between gap-4 md:grid-cols-2 pt-2">
          <div className="flex">
            <img
              className="h-8 w-8"
            ...
            <h1 className="text-3xl font-bold tracking-tight text-blue-600 ml-1">.</h1>
          </div>
            ...
            {LINKS.map(({ title, path }) => (
              <ul key={title}>
                <Typography
                  variant="small"
                  color="blue-gray"
                  className="mb-3 font-medium opacity-40 hover:text-blue-500"
                  as="a"
                  href={path}
                >
                  {title}
        ...
        <div className="mt-12 flex w-full flex-col items-center justify-center border-t border-blue-gray-50 py-4 md:flex-row md:justify-between text-white">
          ...
          >
            &copy; {currentYear} <a className='text-white' href="https://material-tailwind.com/">Silades</a>. All
            Rights Reserved.
          </Typography>
